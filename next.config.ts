...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    // Certification badges in education.json are hosted on Credly.
    remotePatterns: [
      {
        protocol: 'https',
  ...
  async redirects() {
    return [
      ...
      // The Technical Playbook chapter was removed from the page entirely,
      // so its anchor no longer exists either.
