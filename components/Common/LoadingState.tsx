...
function SkeletonLoader({ type = 'card' }: { type: SkeletonType }) {
  ...
  return (
    <div
      className={`${config.height} ${config.width} ${config.rounded} animate-shimmer bg-gradient-to-r from-card via-background to-card dark:from-gray-800 dark:via-gray-700 dark:to-gray-800`}
      style={{
