        ...
        {educationList.map((item, idx) => (
          <article key={idx} className="grid gap-6 py-10 md:grid-cols-[1fr_14rem] md:items-start">
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-primary">{item.cardSubtitle}</p>
              ...
              {item.url && (
                <a
                  ...
                  className="text-on-photo mt-5 inline-block rounded-full border border-border px-4 py-1.5 text-xs font-medium transition-colors hover:border-primary"
                >
                  Learn more ↗
                </a>
              )}
