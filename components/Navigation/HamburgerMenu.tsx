        ...
        {open && (
          <motion.nav
            ...
            onKeyDown={(event: React.KeyboardEvent) => {
              // Keeps focus inside the panel on Tab: without this, tabbing
              // past the last link (or shift-tabbing past the first) would
              // leave the panel for the rest of the page while it is still
              // open and visually in front of it.
            ...
            className="absolute right-0 top-full z-50 mt-2 min-w-48 overflow-hidden rounded-2xl bg-[#fffaf4]/95 py-2 shadow-[0_10px_30px_-12px_rgb(17_28_56/0.45)] ring-1 ring-[#111c38]/10 backdrop-blur-xl dark:bg-[#0c101c]/95 dark:ring-white/10"
          >
