        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mb-12 space-y-6 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 sm:text-xl">
              I build scalable cloud systems and lead high-performing engineering teams. 10+ years of
              experience in backend architecture, DevOps, and full-stack development.
            </p>
          </div>
